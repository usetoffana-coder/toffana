...
- Em **Ações Rápidas**, clique em **Inicializar Banco**
- Fluxo:
1. Primeira confirmação: manter documentos existentes
2. Segunda confirmação (opcional): sobrescrever documentos base
